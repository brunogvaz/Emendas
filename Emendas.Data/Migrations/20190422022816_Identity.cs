    ...
    public partial class Identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Indicacao", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Indicacao_Beneficiarios_BeneficiarioId",
                        column: x => x.BeneficiarioId,
                        principalTable: "Beneficiarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Indicacao_Emendas_EmendaId",
                        column: x => x.EmendaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Indicacao_BeneficiarioId",
                table: "Indicacao",
                column: "BeneficiarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Indicacao_EmendaId",
                table: "Indicacao",
                column: "EmendaId");

            migrationBuilder.AddForeignKey(
                name: "FK_Parlamentars_AspNetUsers_UserId",
                table: "Parlamentars",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
